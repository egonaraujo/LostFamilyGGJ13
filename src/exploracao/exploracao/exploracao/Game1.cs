...
namespace exploracao
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public RenderTarget2D[] blurImg=new RenderTarget2D[4];
        ...
        protected override void LoadContent()
        {
            ...
            button_texture[MenuBar.START_BUTTON_INDEX] = Content.Load<Texture2D>(@"sprites/play1");
            button_texture[MenuBar.QUIT_BUTTON_INDEX] = Content.Load<Texture2D>(@"sprites/sair1");
            menuBar = new MenuBar(button_texture, Content.Load<Texture2D>(@"sprites\arvoreok"), Window.ClientBounds.Width, Window.ClientBounds.Height);
        ...
        {
            game.menuBar.Option = -1;
            game.gameStatus = STS_CHOSING_MENU;
