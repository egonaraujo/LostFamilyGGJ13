...
namespace exploracao
{
    ...
    class Levels
    {
        ...
        public static void initialize()
        {
            ...
            Level.levelX = 0;
            Level.levelY = 1;
            Level.level.respawX=2;
            Level.level.respawY=5;
        ...
        {
            Level anterior = Level.level;
            if (Level.levelX == 0 && Level.levelY == 0)
                Level.level=levels[0, 0] = Level.LoadFromFile("Content\\levels\\A1.oel");
            if (Level.levelX == 1 && Level.levelY == 0)
                Level.level = levels[0, 1] = Level.LoadFromFile("Content\\levels\\B1.oel");
            if (Level.levelX == 2 && Level.levelY == 0)
                Level.level = levels[0, 2] = Level.LoadFromFile("Content\\levels\\C1.oel");
            if (Level.levelX == 3 && Level.levelY == 0)
                Level.level = levels[0, 3] = Level.LoadFromFile("Content\\levels\\D1.oel");

            if (Level.levelX == 0 && Level.levelY == 1)
                Level.level = levels[1, 0] = Level.LoadFromFile("Content\\levels\\A2.oel");
            if (Level.levelX == 1 && Level.levelY == 1)
                Level.level = levels[1, 1] = Level.LoadFromFile("Content\\levels\\B2.oel");
            if (Level.levelX == 2 && Level.levelY == 1)
                Level.level = levels[1, 2] = Level.LoadFromFile("Content\\levels\\C2.oel");
            if (Level.levelX == 3 && Level.levelY == 1)
                Level.level = levels[1, 3] = Level.LoadFromFile("Content\\levels\\D2.oel");

            if (Level.levelX == 0 && Level.levelY == 2)
                Level.level = levels[2, 0] = Level.LoadFromFile("Content\\levels\\A3.oel");
            if (Level.levelX == 1 && Level.levelY == 2)
                Level.level = levels[2, 1] = Level.LoadFromFile("Content\\levels\\B3.oel");
            if (Level.levelX == 2 && Level.levelY == 2)
                Level.level = levels[2, 2] = Level.LoadFromFile("Content\\levels\\C3.oel");
            if (Level.levelX == 3 && Level.levelY == 2)
                Level.level = levels[2, 3] = Level.LoadFromFile("Content\\levels\\D3.oel");

            if (Level.levelX == 0 && Level.levelY == 3)
                Level.level = levels[3, 0] = Level.LoadFromFile("Content\\levels\\A4.oel");
            if (Level.levelX == 1 && Level.levelY == 3)
                Level.level = levels[3, 1] = Level.LoadFromFile("Content\\levels\\B4.oel");
            if (Level.levelX == 2 && Level.levelY == 3)
                Level.level = levels[3, 2] = Level.LoadFromFile("Content\\levels\\C4.oel");
            if (Level.levelX == 3 && Level.levelY == 3)
                Level.level = levels[3, 3] = Level.LoadFromFile("Content\\levels\\D4.oel");

            Level.level.resgate = anterior.resgate;
            Level.level.respawX = anterior.respawX;
            Level.level.respawY = anterior.respawY;
